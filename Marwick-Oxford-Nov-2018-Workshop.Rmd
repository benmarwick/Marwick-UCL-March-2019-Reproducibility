...
Before we do this, we need to do some once-off setup. Let's check that Git is ready for us (in the terminal here):
...
And now we need to introduce ourselves to Git:
...
usethis::use_github(".", 
                    ...
                    auth_token = "74fb84224507b554788c50c4039361b21189350a", 
                    protocol = "https", 
                    private = FALSE)
```
...
Source code hosting:
https://github.com/benmarwick/UO-2018-On-Ramps-to-Reproducibility
