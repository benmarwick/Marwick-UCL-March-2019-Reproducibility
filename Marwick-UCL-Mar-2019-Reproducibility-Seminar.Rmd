---
title: "Four ordered principles to improve the reproducibility of research" 
...
![](figures/nature-comments-code.png)



## Publication is changing {.flexbox .vcenter #myImagePage1}

![](figures/nature-comms-policy.png)

## It's chaos in the long tail {.flexbox .vcenter #myImagePage1}
...
[![](figures/convo_many.png)](https://medium.com/@benmarwick/how-computers-broke-science-and-what-we-can-do-to-fix-it-5d413559ca03#.pjits81yh)
...
![](figures/methods-repro-paragraph.png)

## {.flexbox .vcenter #myImagePage2}

![](figures/deadline.png)


## First principle  {.bigger50} 

<i class="ai ai-figshare ai-1.5x"></i> All files on [zenodo](https://zenodo.org/), [figshare](https://figshare.com/), [OSF](https://osf.io/), university data repo, or similar

<img src="figures/csv.png" alt="" style="width: 50px;"/> Data in CSV or other open format

<i class="fa fa-folder-open-o fa-1.5x"></i> Organised as an [R package](http://r-pkgs.had.co.nz/) or similar convention

## {.flexbox .vcenter #myImagePage1}

![](figures/tas-packaging-data-work.png)

## {.flexbox .vcenter #myImagePage650x500}

![](figures/tas-figs.png)
...
![](figures/r-markdown-demo.png)

## {.flexbox .vcenter #myImagePage650x500}

![](figures/md-image-example.png)

## {.flexbox .vcenter #myImagePage650x500}

![](figures/md-biblio-example.png)
